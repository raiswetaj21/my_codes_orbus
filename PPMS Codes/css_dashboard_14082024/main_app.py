...
# Synthetic Data Creation for cards, charts and graphs
a = new_blog.create_number_card1('Total Project', 83)
b = new_blog.create_number_card1('Completed Project', 46)
c = new_blog.create_number_card1('Total Asset', 102)
d = new_blog.create_number_card1('Asset Under Maintenance', 31)
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card(
                dbc.CardBody(
                    [
                        html.H4(a['title'], className="card-title text-center"),
                        html.H4(a['value'], className="card-title text-center"),
                    ]
                ),
            )
        ], md=3, className='mt-2'),
        dbc.Col([
            dbc.Card(
                dbc.CardBody(
                    [
                        html.H4(b['title'], className="card-title text-center"),
                        html.H4(b['value'], className="card-title text-center"),
                    ]
                ),
            )
        ], md=3, className='mt-2'),
        dbc.Col([
            dbc.Card(
                dbc.CardBody(
                    [
                        html.H4(c['title'], className="card-title text-center"),
                        html.H4(c['value'], className="card-title text-center"),
                    ]
                ),
            )
        ], md=3, className='mt-2'),
        dbc.Col([
            dbc.Card(
                dbc.CardBody(
                    [
                        html.H4(d['title'], className="card-title text-center"),
                        html.H4(d['value'], className="card-title text-center"),
                    ]
                ),
            )
        ], md=3, className='mt-2'),
