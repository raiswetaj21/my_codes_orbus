...
ORDER BY WORK_PC ASC, SWEEPERNAM ASC
"""
...
for ward in ward_names:
    ...
    subject = f"Sweeper Report Email from SCS for {ward}"
    message = f"""
    <html>
    <body>
    <p>Dear Recipient,</p>
    <p>Please find alphabetical bottom 10 sweeper details from {ward} and a detailed spreadsheet in the attachment:</p>
    {dataframe_html}
